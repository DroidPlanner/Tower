...
public class FragmentSetupFSBattery extends SuperSetupMainPanel{

	private ValueKeyData options;
	
	@Override
	public int getPanelLayout() {
		return R.layout.fragment_setup_fs_bat_main;
	}

	@Override
	protected SetupSidePanel getDefaultPanel() {
		sidePanel = new FragmentSetupSend();
		sidePanel.updateTitle(R.string.setup_fs_bat_side_title);
		sidePanel.updateDescription(R.string.setup_fs_bat_side_desc);
		return sidePanel;
	}
	...
	private void setupSpinners() {
		options = ValueKey.getOptions(parentActivity, R.array.FailSafe_Battery_Options);
