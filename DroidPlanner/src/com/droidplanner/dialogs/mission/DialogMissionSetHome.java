...
import com.droidplanner.dialogs.listener.helpers.setHomeItemSelectedListener;
...
public class DialogMissionSetHome extends DialogMission implements
	...
	private void setupViewEnables() {
		...
		lonEditText.setEnabled(!useCurrentCheckBox.isChecked()
				&& coordSrcSpinner.getSelectedItemPosition() == 2);
	...
	private void setupViewListeners() {
		...
		coordSrcSpinner
				.setOnItemSelectedListener(new setHomeItemSelectedListener(this));
	}
