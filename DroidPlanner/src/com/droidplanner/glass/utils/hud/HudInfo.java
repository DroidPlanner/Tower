...
public class HudInfo {
	...
	void drawAttitudeInfoText(HUD huDwidget, Canvas canvas) {
		...
		String fixType = huDwidget.drone.GPS.getFixType();
		...
		// Left Bottom Text
		canvas.drawText(String.format("AS %.1fms", airSpeed), -huDwidget.width
				/ 2 + attPosPxInfoTextXOffset, attPosPxInfoTextLowerTop,
				attInfoText);
		canvas.drawText(String.format("GS %.1fms", groundSpeed),
				-huDwidget.width / 2 + attPosPxInfoTextXOffset,
		...
		canvas.drawText(fixType, huDwidget.width / 2 - attPosPxInfoTextXOffset,
				attPosPxInfoTextUpperTop, attInfoText);
		if (gpsEPH >= 0)
			canvas.drawText(String.format("hp%.1fm", gpsEPH), huDwidget.width
					/ 2 - attPosPxInfoTextXOffset, attPosPxInfoTextUpperBottom,
					attInfoText);

		// Right Bottom Text
		canvas.drawText(modeName,
				huDwidget.width / 2 - attPosPxInfoTextXOffset,
