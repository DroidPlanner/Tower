...
public class MissionDetailFragment extends DialogFragment implements
	...
	public interface OnMissionDetailListener {
		 ...
		 * 
		 * @param itemList
		 *            list of mission items proxies whose details the dialog is
		 *            showing.
		 */
		 ...
		 * 
		 * @param oldNewItemsList
		 *            a list of pairs containing the previous, and the new
		 *            mission item proxy.
		 */
		public void onWaypointTypeChanged(
				List<Pair<MissionItemProxy, MissionItemProxy>> oldNewItemsList);
	}
