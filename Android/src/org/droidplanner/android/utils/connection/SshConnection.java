...
public class SshConnection {
    ...
    private SshSocketFactory sshSocketFactory;

    public SshConnection(String host, String username, String password) {
        this(null, host, username, password);
    }

    public SshConnection(javax.net.SocketFactory socketF, String host, String username, String password) {
        this.jsch = new JSch();
        this.host = host;
        this.username = username;
        this.password = password;
        setSocketFactory(socketF);
    }

    public void setSocketFactory(javax.net.SocketFactory coreFactory) {
        if (coreFactory == null) {
            this.sshSocketFactory = null;
        } else {
            this.sshSocketFactory = new SshSocketFactory(coreFactory);
        }
    }
    ...
    private Session getSession() throws JSchException {
        ...
        if (this.sshSocketFactory != null) {
            session.setSocketFactory(this.sshSocketFactory);
        }
    ...
    private static class SshSocketFactory implements SocketFactory {
        ...
        private final javax.net.SocketFactory netSocketFactory;

        public SshSocketFactory(javax.net.SocketFactory coreSF) {
            this.netSocketFactory = coreSF;
        }

        @Override
        public Socket createSocket(String host, int port) throws IOException, UnknownHostException {
            return netSocketFactory.createSocket(host, port);
        }
