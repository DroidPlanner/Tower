...
import org.droidplanner.android.utils.ar.rendering.TrackerSurfaceView;
import org.droidplanner.android.utils.ar.telemetry.VehicleTelemetry;

/**
 * Tracker Activity and  gl view.
 *
 */
public class TrackerActivity extends AppCompatActivity {
    private TrackerSurfaceView glSurfaceView;
    ...
    private final BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            glSurfaceView.getRenderer().setDrone(drone);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        glSurfaceView = new TrackerSurfaceView(this);
