    ...
    private void updateInfo() {
        if(selectedMsg != null) {
            ...
            if(lastGCSPosition == null || lastGCSPosition.getLatitude() == 0 || lastGCSPosition
                ...
                String distance = getString(R.string.editor_info_window_distance) + String.format(" %.01fm",
            ...
            latView.setText(getString(R.string.waypoint_latitude) + String.format(" %f°", msgCoord.getLatitude()));
            lonView.setText(getString(R.string.waypoint_longitude) + String.format(" %f°", msgCoord.getLongitude()));
        } else {
