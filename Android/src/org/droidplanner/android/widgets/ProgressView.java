...
public class ProgressView extends ProgressBar {
	...
	final int[][] colors = { { 224, 187, 63 }, { 224, 46, 25 }, { 39, 105, 227 }, { 51, 130, 49 } };
	...
	private void transformColor() {
		...
		changeColors(1);
		changeColors(2);
		if (currentColor[0] == colors[nextcolor][0] && currentColor[1] == colors[nextcolor][1]
				&& currentColor[2] == colors[nextcolor][2]) {
			if (nextcolor == 3)
				nextcolor = 0;
			else
				nextcolor++;
