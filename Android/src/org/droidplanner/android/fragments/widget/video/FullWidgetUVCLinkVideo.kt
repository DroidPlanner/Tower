...
public class FullWidgetUVCLinkVideo : TowerWidget() {

    companion object {
        private val filter = initFilter()

        private val TAG = FullWidgetUVCLinkVideo::class.java.simpleName
    ...
    override fun onApiConnected() {
        ...
        broadcastManager.registerReceiver(receiver, FullWidgetUVCLinkVideo.filter)
    }
