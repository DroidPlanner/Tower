...
public class DroidPlannerPrefs {
    ...
    public void persistSurveyPreferences(Survey survey){
        ...
        //Persist the speed
        editor.putFloat(PREF_SURVEY_SPEED, (float) surveyDetail.getSpeed());

        //editor.putBoolean(PREF_SURVEY_SAVEABLE, surveyDetail.isSaveable());

        editor.putBoolean(PREF_SURVEY_SUNNY, surveyDetail.isSunny());
