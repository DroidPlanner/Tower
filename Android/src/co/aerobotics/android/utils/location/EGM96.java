package co.aerobotics.android.utils.location;
...
import co.aerobotics.android.utils.location.gov.nasa.worldwind.util.BufferWrapper;
import co.aerobotics.android.utils.location.gov.nasa.worldwind.util.Logging;
import co.aerobotics.android.utils.location.gov.nasa.worldwind.util.WWIO;
 ...
 * <p/>
 * Once constructed, the instance can be passed to { gov.nasa.worldwind.globes.EllipsoidalGlobe#applyEGMA96Offsets(String)}
...
public class EGM96
{
     ...
     */
    public EGM96(String offsetsFilePath, Context context) throws IOException
    {
        ...
        this.loadOffsetFile(context);
    }

    protected void loadOffsetFile(Context context) throws IOException
    {
        InputStream is = context.getAssets().open(this.offsetsFilePath);
        //WWIO.openFileOrResourceStream(this.offsetsFilePath, EGM96.class);
        if (is == null)
        {
