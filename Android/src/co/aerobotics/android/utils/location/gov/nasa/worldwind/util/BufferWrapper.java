...
public abstract class BufferWrapper
{
    ...
    /**
     * Returns a new BufferWrapper which is a sub-sequence of this buffer. The new buffer starts with the value at the
     ...
     *
     * @return a sub-sequence of this buffer.
     */
    public abstract BufferWrapper getSubBuffer(int index, int length);

    /**
     * Sets a sub-sequence of this buffer with the contents of the specified buffer. The sub-sequence to set starts with
    ...
    /**
     * Sets a sub-sequence of this buffer with the contents of the specified buffer. The subsequence to set starts with
    ...
    /**
     * Returns the buffer's backing data structure. For the standard BufferWrapper types (ByteBufferWrapper,
