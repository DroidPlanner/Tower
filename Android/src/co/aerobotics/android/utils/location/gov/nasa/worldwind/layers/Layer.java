...
public interface Layer extends WWObject, Disposable, Restorable
{
     ...
     * <p/>
     * Most layers enable picking by default. However, this becomes inconvenient for SurfaceImage and SurfaceImageLayer
     * when the image covers a large area because the view input handlers detect the surface image rather than the
     * terrain as the top picked object, and will not respond to the user's attempts at navigation. The solution is to
     * disable picking for the layer.
     *
