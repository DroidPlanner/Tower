...
import co.aerobotics.android.utils.location.gov.nasa.worldwind.Restorable;
...
import co.aerobotics.android.utils.location.gov.nasa.worldwind.render.OffsetsList;
 ...
 * RestorableSupport provides convenience methods for adding and querying state values as Strings, Integers, Doubles,
 * and Booleans.
 *
 * @author dcollins
...
public class RestorableSupport
{
    ...
    public void addStateValueAsLatLon(StateObject context, String name, LatLon location)
    {
        ...
        if (pStateObj != null)
        {
            addStateValueAsDouble(pStateObj, "latitudeDegrees", location.latitude.degrees);
            addStateValueAsDouble(pStateObj, "longitudeDegrees", location.longitude.degrees);
        }
    }
    ...
    public void addStateValueAsPosition(StateObject context, String name, Position position)
    {
        ...
        if (pStateObj != null)
        {
            addStateValueAsDouble(pStateObj, "latitudeDegrees", position.latitude.degrees);
            addStateValueAsDouble(pStateObj, "longitudeDegrees", position.longitude.degrees);
            addStateValueAsDouble(pStateObj, "elevation", position.elevation);
        }
    }
    ...
    public void addStateValueAsSector(StateObject context, String name, Sector sector)
    {
        ...
        if (pStateObj != null)
        {
            addStateValueAsDouble(pStateObj, "minLatitudeDegrees", sector.minLatitude.degrees);
            addStateValueAsDouble(pStateObj, "maxLatitudeDegrees", sector.maxLatitude.degrees);
            addStateValueAsDouble(pStateObj, "minLongitudeDegrees", sector.minLongitude.degrees);
            addStateValueAsDouble(pStateObj, "maxLongitudeDegrees", sector.maxLongitude.degrees);
        }
    }
