...
import co.aerobotics.android.droneshare.data.DroneShareContract.UploadData
...
class DroneShareDB(context: Context) :
        SQLiteOpenHelper(context, co.aerobotics.android.droneshare.data.DroneShareContract.DB_NAME, null, co.aerobotics.android.droneshare.data.DroneShareContract.DB_VERSION) {

    override fun onCreate(db: SQLiteDatabase) {
          Timber.i("Creating ${co.aerobotics.android.droneshare.data.DroneShareContract.DB_NAME} database.")
        val sqlCreateEntries = co.aerobotics.android.droneshare.data.DroneShareContract.getSQLCreateEntries()
    ...
    override fun onUpgrade(db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
        Timber.i("Upgrading ${co.aerobotics.android.droneshare.data.DroneShareContract.DB_NAME} database from version $oldVersion to version $newVersion")
        val sqlDelEntries = co.aerobotics.android.droneshare.data.DroneShareContract.getSQLDeleteEntries()
