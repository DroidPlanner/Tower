...
public class EditInputDialog extends DialogFragment {
    ...
    protected View generateContentView(Bundle savedInstanceState) {
        final View contentView = getActivity().getLayoutInflater().inflate(co.aerobotics.android.R.layout
        ...
        final boolean hintIsValidEntry = arguments.getBoolean(EXTRA_HINT_IS_VALID_ENTRY);
        mEditText = (EditText) contentView.findViewById(co.aerobotics.android.R.id.dialog_edit_text_content);
        if(hintIsValidEntry){
