package co.aerobotics.android.dialogs.openfile;
...
public abstract class OpenFileDialog {
	...
	public void openDialog(Activity activity, final String rootPath, final String[] fileList) {
		if (fileList == null || fileList.length == 0) {
			Toast.makeText(activity, co.aerobotics.android.R.string.no_files, Toast.LENGTH_SHORT).show();
			return;
		}
		...
		dialog.setTitle(co.aerobotics.android.R.string.select_file_to_open);
