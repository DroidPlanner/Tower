...
public class SupportYesNoDialog extends DialogFragment {
    ...
    protected View generateContentView(Bundle savedInstanceState){
        final View contentView = getActivity().getLayoutInflater().inflate(co.aerobotics.android.R.layout.dialog_yes_no_content, null);

        if(contentView == null){
            return contentView;
        }

        final TextView messageView = (TextView) contentView.findViewById(co.aerobotics.android.R.id.yes_no_message);
