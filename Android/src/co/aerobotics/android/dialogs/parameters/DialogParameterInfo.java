package co.aerobotics.android.dialogs.parameters;
...
import co.aerobotics.android.view.adapterViews.ParamsAdapterItem;
...
public class DialogParameterInfo {
	...
	private static View buildView(ParamsAdapterItem item, Context context) {
		...
		final View view = inflater.inflate(co.aerobotics.android.R.layout.fragment_parameters_info, null);

		final Parameter parameter = item.getParameter();
		setTextView(view, co.aerobotics.android.R.id.displayNameView, parameter.getDisplayName());
		setTextView(view, co.aerobotics.android.R.id.nameView, parameter.getName());
		setTextView(view, co.aerobotics.android.R.id.descView, parameter.getDescription());

		setTextLayout(view, co.aerobotics.android.R.id.unitsLayout, co.aerobotics.android.R.id.unitsView, parameter.getUnits());
		setTextLayout(view, co.aerobotics.android.R.id.rangeLayout, co.aerobotics.android.R.id.rangeView, formatRange(parameter.getRange()));

		setTextLayout(view, co.aerobotics.android.R.id.valuesLayout, co.aerobotics.android.R.id.valuesView, parameter.getValues());
		...
		try {
			...
			if (position == -1) {
				...
				strings.add(String.format("%s: %s", formatter.format(dirtyValue), context
						.getResources().getString(co.aerobotics.android.R.string.metadata_custom_value)));
			}
			...
			final ArrayAdapter<String> adapter = new ArrayAdapter<String>(context,
					co.aerobotics.android.R.layout.spinner_param_value_item, strings);
			adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

			// setup spinner
			final Spinner valueSpinner = (Spinner) view.findViewById(co.aerobotics.android.R.id.valueSpinner);
			...
			view.findViewById(co.aerobotics.android.R.id.valueSpinnerView).setVisibility(View.GONE);
			view.findViewById(co.aerobotics.android.R.id.valueTextView).setVisibility(View.VISIBLE);
		}
	}
}
