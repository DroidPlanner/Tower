...
class ReturnToHomeAdapter extends SelectionListAdapter<Integer> {
    ...
    private final int[] rthLabels = {
            co.aerobotics.android.R.string.label_rtl,
            co.aerobotics.android.R.string.label_rtm
    };

    @DrawableRes
    private final int[] rthIcons = {
            co.aerobotics.android.R.drawable.ic_home_grey_700_18dp,
            co.aerobotics.android.R.drawable.ic_person_grey_700_18dp
    };
    ...
    public View getView(final int position, View convertView, ViewGroup parent){
        if(convertView == null){
            convertView = LayoutInflater.from(parent.getContext()).inflate(co.aerobotics.android.R.layout.item_selection, parent, false);
        }

        ViewHolder holder = (ViewHolder) convertView.getTag();
        if(holder == null) {
            holder = new ViewHolder((TextView) convertView.findViewById(co.aerobotics.android.R.id.item_selectable_option),
                    (RadioButton) convertView.findViewById(co.aerobotics.android.R.id.item_selectable_check));
        }
