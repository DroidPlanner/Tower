 ...
 */
class VehicleStatusFragment : co.aerobotics.android.fragments.helpers.ApiListenerFragment() {
    ...
    private val connectedIcon by lazy(LazyThreadSafetyMode.NONE) {
        view?.findViewById(co.aerobotics.android.R.id.status_vehicle_connection) as ImageView?
    }

    private val batteryIcon by lazy(LazyThreadSafetyMode.NONE) {
        view?.findViewById(co.aerobotics.android.R.id.status_vehicle_battery) as ImageView?
    }

    private var titleView: TextView? = null

    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View?{
        return inflater?.inflate(co.aerobotics.android.R.layout.fragment_vehicle_status, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        titleView = view.findViewById(co.aerobotics.android.R.id.status_actionbar_title) as TextView?
