...
public class FlightControlManagerFragment extends ApiListenerFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(co.aerobotics.android.R.layout.fragment_flight_actions_bar, container, false);
	}
	...
	private void selectActionsBar(int droneType, boolean force) {
		...
		//fm.beginTransaction().replace(co.aerobotics.android.R.id.flight_actions_bar, actionsBarFragment).commitAllowingStateLoss();
