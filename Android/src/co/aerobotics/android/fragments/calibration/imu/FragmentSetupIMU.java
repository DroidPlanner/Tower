package co.aerobotics.android.fragments.calibration.imu;
...
import co.aerobotics.android.notifications.TTSNotificationProvider;
...
public class FragmentSetupIMU extends ApiListenerFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(co.aerobotics.android.R.layout.fragment_setup_imu_main, container, false);
	}
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		textViewStep = (TextView) view.findViewById(co.aerobotics.android.R.id.textViewIMUStep);
		textViewOffset = (TextView) view.findViewById(co.aerobotics.android.R.id.TextViewIMUOffset);
		textViewScaling = (TextView) view.findViewById(co.aerobotics.android.R.id.TextViewIMUScaling);
		textViewTimeOut = (TextView) view.findViewById(co.aerobotics.android.R.id.textViewIMUTimeOut);
		pbTimeOut = (ProgressBar) view.findViewById(co.aerobotics.android.R.id.progressBarTimeOut);

        textDesc = (TextView) view.findViewById(co.aerobotics.android.R.id.textViewDesc);

        btnStep = (Button) view.findViewById(co.aerobotics.android.R.id.buttonStep);
        btnStep.setEnabled(false);
		...
		timeLeftStr = getString(co.aerobotics.android.R.string.setup_imu_timeleft);

		drawableGood = getResources().getDrawable(co.aerobotics.android.R.drawable.pstate_good);
		drawableWarning = getResources().getDrawable(co.aerobotics.android.R.drawable.pstate_warning);
		drawablePoor = getResources().getDrawable(co.aerobotics.android.R.drawable.pstate_poor);
	...
	private void processCalibrationStep(int step) {
		if (step == 0) {
            ...
            textViewStep.setText(co.aerobotics.android.R.string.setup_imu_step);
    ...
    public void updateDescription(int calibration_step) {
        ...
        switch (calibration_step) {
            case 0:
                id = co.aerobotics.android.R.string.setup_imu_start;
                break;
            case 1:
                id = co.aerobotics.android.R.string.setup_imu_normal;
                break;
            case 2:
                id = co.aerobotics.android.R.string.setup_imu_left;
                break;
            case 3:
                id = co.aerobotics.android.R.string.setup_imu_right;
                break;
            case 4:
                id = co.aerobotics.android.R.string.setup_imu_nosedown;
                break;
            case 5:
                id = co.aerobotics.android.R.string.setup_imu_noseup;
                break;
            case 6:
                id = co.aerobotics.android.R.string.setup_imu_back;
                break;
            case 7:
                id = co.aerobotics.android.R.string.setup_imu_completed;
                break;
            default:
                return;
        }
        ...
        if (btnStep != null) {
            if (calibration_step == 0)
                btnStep.setText(co.aerobotics.android.R.string.button_setup_calibrate);
            else if (calibration_step == 7)
                btnStep.setText(co.aerobotics.android.R.string.button_setup_done);
            else
                btnStep.setText(co.aerobotics.android.R.string.button_setup_next);
        }
		...
		if (dpApi.isConnected()) {
            CalibrationApi.getApi(dpApi).startIMUCalibration(new SimpleCommandListener(){
                ...
                public void onError(int error){
                    Toast.makeText(getActivity(), co.aerobotics.android.R.string.imu_calibration_start_error, Toast.LENGTH_LONG).show();
                }
            });
		}
	}
