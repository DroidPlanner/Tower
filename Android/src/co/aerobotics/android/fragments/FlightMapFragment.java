...
public class FlightMapFragment extends DroneMap implements DPMap.OnMapLongClickListener,
        DPMap.OnMarkerClickListener, DPMap.OnMarkerDragListener, GuidedDialog.GuidedDialogListener {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater){
        ...
        inflater.inflate(co.aerobotics.android.R.menu.menu_flight_map, menu);
    }

    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case co.aerobotics.android.R.id.menu_map_clear_flight_path:
                clearFlightPath();
                return true;

            case co.aerobotics.android.R.id.menu_export_flight_path_as_mission:
                if (flightPathPoints.isEmpty()) {
                    Toast.makeText(getContext(), co.aerobotics.android.R.string.error_empty_flight_path, Toast.LENGTH_LONG).show();
                    return true;
                }
                ...
                clearFlightPath();
                Toast.makeText(getContext(), co.aerobotics.android.R.string.warning_check_exported_mission, Toast.LENGTH_LONG).show();
                return true;
    ...
    public void goToMyLocation() {
        ...
        if (pressCount < MAX_TOASTS_FOR_LOCATION_PRESS) {
            Toast.makeText(context, co.aerobotics.android.R.string.user_autopan_long_press, Toast.LENGTH_LONG).show();
    ...
    public void goToDroneLocation() {
        ...
        if (pressCount < MAX_TOASTS_FOR_LOCATION_PRESS) {
            Toast.makeText(context, co.aerobotics.android.R.string.drone_autopan_long_press, Toast.LENGTH_LONG).show();
