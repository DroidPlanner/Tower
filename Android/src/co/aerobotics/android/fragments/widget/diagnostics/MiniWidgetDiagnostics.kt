...
class MiniWidgetDiagnostics : BaseWidgetDiagnostic() {
    ...
    private val okFlagDrawable: Drawable? by lazy(LazyThreadSafetyMode.NONE) {
        resources?.getDrawable(co.aerobotics.android.R.drawable.ic_check_box_green_500_18dp)
    }

    private val badFlagDrawable: Drawable? by lazy(LazyThreadSafetyMode.NONE) {
        resources?.getDrawable(co.aerobotics.android.R.drawable.ic_cancel_red_500_18dp)
    }

    private val warningFlagDrawable by lazy(LazyThreadSafetyMode.NONE) {
        resources?.getDrawable(co.aerobotics.android.R.drawable.ic_warning_orange_500_18dp)
    }

    private val unknownFlagDrawable: Drawable? by lazy(LazyThreadSafetyMode.NONE) {
        resources?.getDrawable(co.aerobotics.android.R.drawable.ic_help_grey_600_18dp)
    }

    private val ekfStatusView by lazy(LazyThreadSafetyMode.NONE) {
        view?.findViewById(co.aerobotics.android.R.id.ekf_status) as TextView?
    }

    private val vibrationStatus by lazy(LazyThreadSafetyMode.NONE) {
        view?.findViewById(co.aerobotics.android.R.id.vibration_status) as TextView?
    }

    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater?.inflate(co.aerobotics.android.R.layout.fragment_mini_widget_ekf_status, container, false)
    }
