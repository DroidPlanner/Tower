...
abstract class GraphDiagnosticViewer : BaseWidgetDiagnostic() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater?.inflate(co.aerobotics.android.R.layout.fragment_graph_diagnostic_viewer, container, false)
    }
    ...
    private fun setupGraph(view: View) {
        graph = view.findViewById(co.aerobotics.android.R.id.column_chart) as ColumnChartView?
