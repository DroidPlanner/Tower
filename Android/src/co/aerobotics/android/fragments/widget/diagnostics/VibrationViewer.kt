...
class VibrationViewer : GraphDiagnosticViewer() {
    ...
    companion object {
        @StringRes val LABEL_ID: Int = co.aerobotics.android.R.string.title_vibration_viewer
    }
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View?{
        return inflater?.inflate(co.aerobotics.android.R.layout.fragment_vibration_viewer, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        super.onViewCreated(view, savedInstanceState)

        clippingViews.set(0, view.findViewById(co.aerobotics.android.R.id.primary_clipping_value) as TextView?)
        clippingViews.set(1, view.findViewById(co.aerobotics.android.R.id.secondary_clipping_value) as TextView?)
        clippingViews.set(2, view.findViewById(co.aerobotics.android.R.id.tertiary_clipping_value) as TextView?)
    }
    ...
    private fun disableClippingTracker(){
        fun disableClippingValue(index: Int){
            val clippingView = clippingViews.get(index)
            clippingView?.setText(co.aerobotics.android.R.string.empty_content)
