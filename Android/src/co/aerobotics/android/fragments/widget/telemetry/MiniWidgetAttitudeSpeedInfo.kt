 ...
 */
class MiniWidgetAttitudeSpeedInfo : TowerWidget() {
    ...
    private var attitudeIndicator: co.aerobotics.android.view.AttitudeIndicator? = null
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater?.inflate(co.aerobotics.android.R.layout.fragment_mini_widget_attitude_speed_info, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        attitudeIndicator = view.findViewById(co.aerobotics.android.R.id.aiView) as co.aerobotics.android.view.AttitudeIndicator?

        roll = view.findViewById(co.aerobotics.android.R.id.rollValueText) as TextView?
        yaw = view.findViewById(co.aerobotics.android.R.id.yawValueText) as TextView?
        pitch = view.findViewById(co.aerobotics.android.R.id.pitchValueText) as TextView?

        horizontalSpeed = view.findViewById(co.aerobotics.android.R.id.horizontal_speed_telem) as TextView?
        verticalSpeed = view.findViewById(co.aerobotics.android.R.id.vertical_speed_telem) as TextView?
    ...
    private fun onSpeedUpdate() {
        ...
        horizontalSpeed?.text = getString(co.aerobotics.android.R.string.horizontal_speed_telem, speedUnitProvider.boxBaseValueToTarget(groundSpeedValue).toString())
        verticalSpeed?.text = getString(co.aerobotics.android.R.string.vertical_speed_telem, speedUnitProvider.boxBaseValueToTarget(verticalSpeedValue).toString())
    }
}