 ...
 */
class MiniWidgetFlightTimer : TowerWidget(), co.aerobotics.android.dialogs.SupportYesNoDialog.Listener {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View?{
        return inflater?.inflate(co.aerobotics.android.R.layout.fragment_mini_widget_flight_timer, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        flightTimer = view.findViewById(co.aerobotics.android.R.id.flight_timer) as TextView?
        flightTimer?.setOnClickListener {
            //Bring up a dialog allowing the user to reset the timer.
            val resetTimerDialog = co.aerobotics.android.dialogs.SupportYesNoDialog.newInstance(context, RESET_TIMER_TAG,
                    context.getString(co.aerobotics.android.R.string.label_widget_flight_timer),
                    context.getString(co.aerobotics.android.R.string.description_reset_flight_timer))
