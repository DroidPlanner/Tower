...
import co.aerobotics.android.fragments.mode.FlightModePanel;
...
import co.aerobotics.android.activities.DrawerNavigationUI;
import co.aerobotics.android.fragments.control.FlightControlManagerFragment;
...
public class FlightDataFragment extends ApiListenerFragment implements SlidingDrawer.OnDrawerOpenListener, SlidingDrawer.OnDrawerCloseListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (showActionDrawerToggle) {
            actionDrawerToggle.setVisibility(View.INVISIBLE);
