...
import co.aerobotics.android.activities.FlightActivity;
...
public class StatusBarNotificationProvider implements NotificationHandler.NotificationProvider {
    ...
    public void init(){
        ...
        final String summaryText = mContext.getString(co.aerobotics.android.R.string.connected);

        mInboxBuilder = new InboxStyleBuilder().setSummary(summaryText);
        mNotificationBuilder = new NotificationCompat.Builder(mContext)
                .addAction(co.aerobotics.android.R.drawable.ic_action_io, mContext.getText(co.aerobotics.android.R.string.menu_disconnect),
                        mToggleConnectionIntent)
                .setContentIntent(mNotificationIntent)
                .setContentText(summaryText)
                .setOngoing(false)
                .setSmallIcon(co.aerobotics.android.R.drawable.ic_stat_notify)
                .setColor(mContext.getResources().getColor(co.aerobotics.android.R.color.stat_notify_connected));
    ...
    public void onTerminate() {
        ...
        if (mNotificationBuilder != null) {
            mNotificationBuilder = new NotificationCompat.Builder(mContext)
                    .addAction(co.aerobotics.android.R.drawable.ic_action_io,
                            mContext.getText(co.aerobotics.android.R.string.menu_connect), mToggleConnectionIntent)
                    .setContentIntent(mNotificationIntent)
                    .setContentTitle(mContext.getString(co.aerobotics.android.R.string.disconnected))
