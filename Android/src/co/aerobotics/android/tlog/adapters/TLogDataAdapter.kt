 ...
 */
class TLogDataAdapter(val app: co.aerobotics.android.DroidPlannerApp, val fragmentMgr: FragmentManager, val selectedSessionId: Long) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.clearSession.setOnClickListener {
            ...
            val confirmDialog = co.aerobotics.android.dialogs.OkDialog.newInstance(app.applicationContext, "Delete?", "Delete session ${sessionData.label}?", object : co.aerobotics.android.dialogs.OkDialog.Listener{
                override fun onOk() {
        ...
        holder.editLabel.setOnClickListener {
            ...
            val renameDialog = co.aerobotics.android.dialogs.SupportEditInputDialog.newInstance(RENAME_SESSION_TAG,
                ...
                override fun onOk(dialogTag: String?, input: CharSequence?) {
                    if (TextUtils.isEmpty(input)) {
                        Toast.makeText(app.applicationContext, co.aerobotics.android.R.string.warning_invalid_session_label_entry, Toast.LENGTH_LONG).show()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder? {
        val containerView = LayoutInflater.from(parent.context).inflate(co.aerobotics.android.R.layout.list_item_tlog_data, parent, false)
        val dataLabel = containerView.findViewById(co.aerobotics.android.R.id.tlog_data_label) as TextView
        val clearSession = containerView.findViewById(co.aerobotics.android.R.id.clear_tlog_session)
        val editLabel = containerView.findViewById(co.aerobotics.android.R.id.rename_tlog_session)
