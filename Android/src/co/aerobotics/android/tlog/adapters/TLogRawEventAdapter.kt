...
import co.aerobotics.android.view.adapterViews.OnLoadMoreListener
...
class TLogRawEventAdapter(recyclerView: RecyclerView, onLoadMoreListener: OnLoadMoreListener?) :
    ...
    override fun onCreateBasicItemViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val eventView = LayoutInflater.from(parent.context).inflate(co.aerobotics.android.R.layout.list_item_tlog_raw_event, parent, false)
        val eventTimestamp = eventView.findViewById(co.aerobotics.android.R.id.event_timestamp) as TextView
        val eventInfo = eventView.findViewById(co.aerobotics.android.R.id.event_info) as TextView
    ...
    override fun onCreateFooterViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val v = LayoutInflater.from(parent.context).inflate(co.aerobotics.android.R.layout.progress_bar, parent, false)
        val progressBar = v.findViewById(co.aerobotics.android.R.id.progressBar) as ProgressBar
