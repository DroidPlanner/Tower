...
import co.aerobotics.android.tlog.adapters.TLogRawEventAdapter
...
class TLogRawViewer : TLogViewer() {
    ...
    private val noTLogView by lazy {
        view?.findViewById(co.aerobotics.android.R.id.no_tlog_selected) as TextView?
    }

    private val fastScroller by lazy {
        view?.findViewById(co.aerobotics.android.R.id.raw_fastscroller) as FastScroller
    }

    private val rawData by lazy {
        view?.findViewById(co.aerobotics.android.R.id.tlog_raw_data) as RecyclerView?
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(co.aerobotics.android.R.layout.fragment_tlog_raw_viewer, container, false)
    }
