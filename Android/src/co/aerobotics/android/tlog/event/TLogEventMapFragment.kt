package co.aerobotics.android.tlog.event
 ...
 */
class TLogEventMapFragment : co.aerobotics.android.fragments.DroneMap(), TLogDataSubscriber, TLogEventListener {
    ...
    private class GlobalPositionMarkerInfo : co.aerobotics.android.maps.MarkerInfo() {
        ...
        override fun getIcon(res: Resources) = BitmapFactory.decodeResource(res, co.aerobotics.android.R.drawable.quad_disconnect)
    }
}