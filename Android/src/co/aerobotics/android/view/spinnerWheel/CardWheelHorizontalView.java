...
import co.aerobotics.android.view.spinnerWheel.adapters.AbstractWheelTextAdapter;
...
public class  CardWheelHorizontalView<T> extends LinearLayout implements OnWheelChangedListener,
	...
	private void initialize(final Context context, AttributeSet attrs) {
		final TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
				co.aerobotics.android.R.styleable.CardWheelHorizontalView, 0, 0);

		try {
			// Setup the container view.
			setBackgroundResource(co.aerobotics.android.R.drawable.bg_cell_white);

			// Setup the children views
			final LayoutInflater inflater = LayoutInflater.from(context);

			// Setup the divider view
			mVerticalDivider = inflater.inflate(co.aerobotics.android.R.layout.card_title_vertical_divider, this, false);
			mHorizontalDivider = inflater.inflate(co.aerobotics.android.R.layout.card_title_horizontal_divider, this,	false);

			// Setup the title view
			mTitleView = (TextView) inflater.inflate(co.aerobotics.android.R.layout.card_wheel_horizontal_view_title,	this, false);
			mTitleView.setText(a.getString(co.aerobotics.android.R.styleable.CardWheelHorizontalView_android_text));

			final int orientation = a.getInt(co.aerobotics.android.R.styleable.CardWheelHorizontalView_android_orientation, VERTICAL);
			...
			final View spinnerWheelFrame = inflater.inflate(co.aerobotics.android.R.layout.card_wheel_horizontal_view, this, false);
			addView(spinnerWheelFrame);

			mSpinnerWheel = (WheelHorizontalView) spinnerWheelFrame.findViewById(co.aerobotics.android.R.id.horizontalSpinnerWheel);
			mSpinnerWheel.addChangingListener(this);
			mSpinnerWheel.addClickingListener(this);
			mSpinnerWheel.addScrollingListener(this);

			mNumberInputText = (EditText) spinnerWheelFrame.findViewById(co.aerobotics.android.R.id.numberInputText);
