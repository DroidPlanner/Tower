...
public class ListRow_Note extends ListRow implements OnFocusChangeListener {
	...
	public View getView(View convertView) {
		View view;
		if (convertView == null) {
			ViewGroup viewGroup = (ViewGroup) inflater.inflate(co.aerobotics.android.R.layout.list_note_item, null);
	...
	private static class ViewHolder extends BaseViewHolder {
		...
		protected void setupViewItems(ViewGroup viewGroup, CheckListItem checkListItem) {
			this.editTextView = (EditText) viewGroup.findViewById(co.aerobotics.android.R.id.lst_note);
		}
	}
