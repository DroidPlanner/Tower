...
public class UserDataAdapter extends RecyclerView.Adapter<UserDataAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext()).inflate(co.aerobotics.android.R.layout.list_item_vehicle_info, parent,
                false);

        final TextView vehicleName = (TextView) view.findViewById(co.aerobotics.android.R.id.vehicle_name);
        final TextView vehicleType = (TextView) view.findViewById(co.aerobotics.android.R.id.vehicle_type);
        final TextView autopilot = (TextView) view.findViewById(co.aerobotics.android.R.id.vehicle_autopilot);
        final TextView missionInfo = (TextView) view.findViewById(co.aerobotics.android.R.id.vehicle_mission_info);
