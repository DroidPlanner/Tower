...
public class BaiduMapOfflineMapPreference extends DialogPreference implements MKOfflineMapListener {
    ...
    private void initView(View view) {
        ...
        mCidView = (TextView) view.findViewById(co.aerobotics.android.R.id.cityid);
        mCityNameView = (EditText) view.findViewById(co.aerobotics.android.R.id.city);
        mStateView = (TextView) view.findViewById(co.aerobotics.android.R.id.state);

        ListView hotCityList = (ListView) view.findViewById(co.aerobotics.android.R.id.hotcitylist);
        ...
        ListAdapter hAdapter = new ArrayAdapter<String>(this.getContext(),
        ...
        ListAdapter aAdapter = new ArrayAdapter<String>(this.getContext(),
