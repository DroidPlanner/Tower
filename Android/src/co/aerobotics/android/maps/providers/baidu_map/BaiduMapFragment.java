...
public class BaiduMapFragment extends SupportMapFragment implements DPMap {
            ...
            switch (action) {
                ...
                case com.baidu.mapapi.SDKInitializer.SDK_BROADTCAST_ACTION_STRING_PERMISSION_CHECK_ERROR:
                    Toast.makeText(getActivity().getApplicationContext(),
                            co.aerobotics.android.R.string.baidu_map_sdk_initializer_permission_error_message, Toast.LENGTH_LONG).show();
                    break;
                case com.baidu.mapapi.SDKInitializer.SDK_BROADCAST_ACTION_STRING_NETWORK_ERROR:
                    Toast.makeText(getActivity().getApplicationContext(),
                            co.aerobotics.android.R.string.baidu_map_sdk_initializer_network_error_message, Toast.LENGTH_LONG).show();
                    break;
            }
        }
    };
    ...
    public void onAttach(Activity activity) {
        ...
        mDpApp = DroidPlannerApp.getInstance();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        baseBottomPadding = (int) getResources().getDimension(co.aerobotics.android.R.dimen.mission_control_bar_height);
    ...
    @Override
    public void addPolygon(com.google.android.gms.maps.model.PolygonOptions polygonOptions, String id) {
    ...
    public void goToDroneLocation() {
        ...
        if (!gps.isValid()) {
            Toast.makeText(getActivity().getApplicationContext(),
                    co.aerobotics.android.R.string.drone_no_location, Toast.LENGTH_SHORT).show();
            return;
        }
