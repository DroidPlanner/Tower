package co.aerobotics.android.maps.providers.google_map.tiles.arcgis
...
class ArcGISTileProviderManager(val context: Context, val selectedMap: String) :
        co.aerobotics.android.maps.providers.google_map.tiles.TileProviderManager(
    ...
    internal enum class MapType(@StringRes val labelResId: Int, val maxZoomLevel: Int, val baseUrl: String) {
        NAT_GEO_WORLD_MAP(co.aerobotics.android.R.string.label_nat_geo_world_map, 16, "http://services.arcgisonline.com/arcgis/rest/services/NatGeo_World_Map/MapServer/tile"),
        WORLD_IMAGERY(co.aerobotics.android.R.string.label_world_imagery, 23, "http://services.arcgisonline.com/arcgis/rest/services/World_Imagery/MapServer/tile"),
        WORLD_STREET_MAP(co.aerobotics.android.R.string.label_world_street_map, 23, "http://services.arcgisonline.com/arcgis/rest/services/World_Street_Map/MapServer/tile"),
        WORLD_TOPO_MAP(co.aerobotics.android.R.string.label_world_topo_map, 23, "http://services.arcgisonline.com/arcgis/rest/services/World_Topo_Map/MapServer/tile");
    ...
    override fun downloadMapTiles(mapDownloader: co.aerobotics.android.maps.providers.google_map.tiles.mapbox.offline.MapDownloader, mapRegion: co.aerobotics.android.maps.DPMap.VisibleMapArea,
