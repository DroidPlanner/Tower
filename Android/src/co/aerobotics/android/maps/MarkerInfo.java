...
import co.aerobotics.android.proxy.mission.item.markers.PolygonMarkerInfo;
...
public abstract class MarkerInfo {
    private String MARKER_UPDATE = "marker_info_update";
	...
	public final void updateMarker(DroneMap droneMap){
		...
		if(proxyMarker == null){
			...
			if (this instanceof PolygonMarkerInfo){
				Log.d(MARKER_UPDATE, "polymarker");
				proxyMarker.setDraggable(droneMap.isMissionDraggable());
			} else {
