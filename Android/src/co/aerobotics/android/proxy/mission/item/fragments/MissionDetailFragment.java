...
import co.aerobotics.android.fragments.helpers.ApiListenerDialogFragment;
...
public class MissionDetailFragment extends ApiListenerDialogFragment {
    ...
    protected int getResource() {
        return co.aerobotics.android.R.layout.fragment_editor_detail_generic;
    }
    ...
    public void onApiConnected() {
        ...
        distanceView = (TextView) view.findViewById(co.aerobotics.android.R.id.DistanceValue);
        if(distanceView != null)
            distanceView.setVisibility(View.GONE);

        distanceLabelView = (TextView) view.findViewById(co.aerobotics.android.R.id.DistanceLabel);
        ...
        if (mSelectedProxies.size() == 1) {
            ...
            TextView waypointIndex = (TextView) view.findViewById(co.aerobotics.android.R.id.WaypointIndex);
        ...
        if(getResource() == co.aerobotics.android.R.layout.fragment_editor_detail_generic) {
            TextView spinnerTitle = (TextView) view.findViewById(co.aerobotics.android.R.id.WaypointType);
            TextView spinnerDescription = (TextView) view.findViewById(co.aerobotics.android.R.id.mission_item_type_selection_description);

            if (list.isEmpty()) {
                if (spinnerTitle != null)
                    spinnerTitle.setText(co.aerobotics.android.R.string.label_mission_item_type_no_selection);

                if (spinnerDescription != null)
                    spinnerDescription.setText(co.aerobotics.android.R.string.description_mission_item_type_no_selection);
            } else {
                if (spinnerTitle != null)
                    spinnerTitle.setText(co.aerobotics.android.R.string.label_mission_item_type_selection);

                if (spinnerDescription != null)
                    spinnerDescription.setText(co.aerobotics.android.R.string.description_mission_item_type_selection);
            }
        }
        ...
        //typeSpinner = (SpinnerSelfSelect) view.findViewById(co.aerobotics.android.R.id.spinnerWaypointType);
