...
public class msg_set_position_target_global_int extends MAVLinkMessage{
	...
	*/
    ...
    public void unpack(MAVLinkPayload payload) {
	    ...
	    lat_int = payload.getInt();
	    lon_int = payload.getInt();
    ...
    public msg_set_position_target_global_int(MAVLinkPacket mavLinkPacket){
        ...
        //Log.d("MAVLink", "SET_POSITION_TARGET_GLOBAL_INT");
        //Log.d("MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT", toString());
    }
    ...
    public String toString(){
    	return "MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT -"+" time_boot_ms:"+time_boot_ms+" lat_int:"+lat_int+" lon_int:"+lon_int+" alt:"+alt+" vx:"+vx+" vy:"+vy+" vz:"+vz+" afx:"+afx+" afy:"+afy+" afz:"+afz+" type_mask:"+type_mask+" target_system:"+target_system+" target_component:"+target_component+" coordinate_frame:"+coordinate_frame+"";
    }
}
