...
*/
public class msg_autopilot_version_request_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_AUTOPILOT_VERSION_REQUEST);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_AUTOPILOT_VERSION_REQUEST); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_autopilot_version_request", processedPacket, packet);
}
}
