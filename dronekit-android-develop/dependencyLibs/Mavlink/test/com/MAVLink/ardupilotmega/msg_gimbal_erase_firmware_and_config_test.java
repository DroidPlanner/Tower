...
*/
public class msg_gimbal_erase_firmware_and_config_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_GIMBAL_ERASE_FIRMWARE_AND_CONFIG);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_GIMBAL_ERASE_FIRMWARE_AND_CONFIG); //msg id
    payload.putInt((int)963497464); //knock
...
public void test(){
    ...
    assertArrayEquals("msg_gimbal_erase_firmware_and_config", processedPacket, packet);
}
}
