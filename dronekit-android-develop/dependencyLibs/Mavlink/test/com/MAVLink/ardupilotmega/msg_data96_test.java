...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_DATA96);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_DATA96); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_data96", processedPacket, packet);
}
}
