...
*/
public class msg_remote_log_data_block_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_REMOTE_LOG_DATA_BLOCK);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_REMOTE_LOG_DATA_BLOCK); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_remote_log_data_block", processedPacket, packet);
}
}
