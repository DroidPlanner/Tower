...
*/
public class msg_gimbal_factory_parameters_loaded_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_GIMBAL_FACTORY_PARAMETERS_LOADED);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_GIMBAL_FACTORY_PARAMETERS_LOADED); //msg id
    payload.put((byte)5); //dummy
...
public void test(){
    ...
    assertArrayEquals("msg_gimbal_factory_parameters_loaded", processedPacket, packet);
}
}
