...
*/
public class msg_gopro_set_response_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_GOPRO_SET_RESPONSE);
    return crc;
}
...
public void test(){
    ...
    assertArrayEquals("msg_gopro_set_response", processedPacket, packet);
}
}
