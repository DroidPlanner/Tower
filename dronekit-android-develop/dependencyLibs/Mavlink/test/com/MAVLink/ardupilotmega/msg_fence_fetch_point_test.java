...
*/
public class msg_fence_fetch_point_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_FENCE_FETCH_POINT);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_FENCE_FETCH_POINT); //msg id
    payload.put((byte)5); //target_system
    payload.put((byte)72); //target_component
    payload.put((byte)139); //idx
...
public void test(){
    ...
    assertArrayEquals("msg_fence_fetch_point", processedPacket, packet);
}
}
