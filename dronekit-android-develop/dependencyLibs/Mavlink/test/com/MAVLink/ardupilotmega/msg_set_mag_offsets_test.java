...
*/
public class msg_set_mag_offsets_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_SET_MAG_OFFSETS);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_SET_MAG_OFFSETS); //msg id
    payload.putShort((short)17235); //mag_ofs_x
    payload.putShort((short)17339); //mag_ofs_y
    payload.putShort((short)17443); //mag_ofs_z
...
public void test(){
    ...
    assertArrayEquals("msg_set_mag_offsets", processedPacket, packet);
}
}
