...
*/
public class msg_rally_fetch_point_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_RALLY_FETCH_POINT);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_RALLY_FETCH_POINT); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_rally_fetch_point", processedPacket, packet);
}
}
