...
*/
public class msg_gopro_get_request_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_GOPRO_GET_REQUEST);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_GOPRO_GET_REQUEST); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_gopro_get_request", processedPacket, packet);
}
}
