...
*/
public class msg_gimbal_perform_factory_tests_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_GIMBAL_PERFORM_FACTORY_TESTS);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_GIMBAL_PERFORM_FACTORY_TESTS); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_gimbal_perform_factory_tests", processedPacket, packet);
}
}
