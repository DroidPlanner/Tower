...
*/
public class msg_set_position_target_local_ned_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_SET_POSITION_TARGET_LOCAL_NED); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_set_position_target_local_ned", processedPacket, packet);
}
}
