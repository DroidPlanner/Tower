...
*/
public class msg_terrain_check_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_TERRAIN_CHECK);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_TERRAIN_CHECK); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_terrain_check", processedPacket, packet);
}
}
