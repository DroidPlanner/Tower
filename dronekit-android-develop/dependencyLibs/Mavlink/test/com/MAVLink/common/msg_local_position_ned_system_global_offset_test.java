...
*/
public class msg_local_position_ned_system_global_offset_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_local_position_ned_system_global_offset", processedPacket, packet);
}
}
