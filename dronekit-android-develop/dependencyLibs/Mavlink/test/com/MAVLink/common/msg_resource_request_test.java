...
*/
public class msg_resource_request_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_RESOURCE_REQUEST);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_RESOURCE_REQUEST); //msg id
    payload.put((byte)5); //request_id
    payload.put((byte)72); //uri_type
    //uri
    ...
    payload.put((byte)1);
    payload.put((byte)2);
    payload.put((byte)243); //transfer_type
    //storage
    payload.put((byte)54);
    payload.put((byte)55);
    payload.put((byte)56);
...
public void test(){
    ...
    assertArrayEquals("msg_resource_request", processedPacket, packet);
}
}
