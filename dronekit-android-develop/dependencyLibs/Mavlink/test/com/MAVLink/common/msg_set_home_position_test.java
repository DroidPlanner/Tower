...
*/
public class msg_set_home_position_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_SET_HOME_POSITION);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_SET_HOME_POSITION); //msg id
    ...
    payload.put((byte)161); //target_system
...
public void test(){
    ...
    assertArrayEquals("msg_set_home_position", processedPacket, packet);
}
}
