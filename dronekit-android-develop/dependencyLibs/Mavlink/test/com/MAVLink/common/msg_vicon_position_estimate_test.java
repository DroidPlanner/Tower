...
* 
*/
public class msg_vicon_position_estimate_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_vicon_position_estimate", processedPacket, packet);
}
}
