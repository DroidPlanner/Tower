...
*/
public class msg_mission_request_list_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_MISSION_REQUEST_LIST);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_MISSION_REQUEST_LIST); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_mission_request_list", processedPacket, packet);
}
}
