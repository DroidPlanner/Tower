...
*/
public class msg_mission_set_current_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_MISSION_SET_CURRENT);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_MISSION_SET_CURRENT); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_mission_set_current", processedPacket, packet);
}
}
