...
*/
public class msg_log_request_end_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_LOG_REQUEST_END);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_LOG_REQUEST_END); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_log_request_end", processedPacket, packet);
}
}
