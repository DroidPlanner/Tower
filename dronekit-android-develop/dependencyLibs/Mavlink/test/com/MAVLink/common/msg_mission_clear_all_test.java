...
*/
public class msg_mission_clear_all_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_MISSION_CLEAR_ALL);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_MISSION_CLEAR_ALL); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_mission_clear_all", processedPacket, packet);
}
}
