...
*/
public class msg_position_target_global_int_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_POSITION_TARGET_GLOBAL_INT);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_POSITION_TARGET_GLOBAL_INT); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_position_target_global_int", processedPacket, packet);
}
}
