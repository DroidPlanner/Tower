...
* 
*/
public class msg_vision_speed_estimate_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_VISION_SPEED_ESTIMATE); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_vision_speed_estimate", processedPacket, packet);
}
}
