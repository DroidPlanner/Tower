...
*/
public class msg_scaled_imu_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_SCALED_IMU);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_SCALED_IMU); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_scaled_imu", processedPacket, packet);
}
}
