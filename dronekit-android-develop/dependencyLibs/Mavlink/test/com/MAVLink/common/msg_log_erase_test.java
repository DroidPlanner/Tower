...
* Erase all logs
*/
public class msg_log_erase_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_LOG_ERASE);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_LOG_ERASE); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_log_erase", processedPacket, packet);
}
}
