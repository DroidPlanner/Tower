...
*/
public class msg_mission_item_reached_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_MISSION_ITEM_REACHED);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_MISSION_ITEM_REACHED); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_mission_item_reached", processedPacket, packet);
}
}
