...
*/
public class msg_scaled_imu3_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_SCALED_IMU3);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_SCALED_IMU3); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_scaled_imu3", processedPacket, packet);
}
}
