...
*/
public class msg_scaled_pressure3_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_SCALED_PRESSURE3);
    return crc;
}
...
public void test(){
    ...
    assertArrayEquals("msg_scaled_pressure3", processedPacket, packet);
}
}
