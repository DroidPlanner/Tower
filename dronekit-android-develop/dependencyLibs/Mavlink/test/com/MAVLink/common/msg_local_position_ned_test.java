...
*/
public class msg_local_position_ned_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_LOCAL_POSITION_NED);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_LOCAL_POSITION_NED); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_local_position_ned", processedPacket, packet);
}
}
