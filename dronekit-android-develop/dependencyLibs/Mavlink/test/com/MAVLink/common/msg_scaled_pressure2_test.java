...
*/
public class msg_scaled_pressure2_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_SCALED_PRESSURE2);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_SCALED_PRESSURE2); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_scaled_pressure2", processedPacket, packet);
}
}
