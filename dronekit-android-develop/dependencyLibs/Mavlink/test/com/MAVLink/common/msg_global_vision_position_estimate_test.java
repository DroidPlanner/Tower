...
* 
*/
public class msg_global_vision_position_estimate_test{
...
public CRC generateCRC(byte[] packet){
    ...
    crc.finish_checksum(MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE);
    return crc;
}
...
public byte[] generateTestPacket(){
    ...
    payload.put((byte)MAVLINK_MSG_ID_GLOBAL_VISION_POSITION_ESTIMATE); //msg id
...
public void test(){
    ...
    assertArrayEquals("msg_global_vision_position_estimate", processedPacket, packet);
}
}
