...
/**
 * This class contains logic used to send an heartbeat to a {@link org.droidplanner.core.drone.Drone}.
 * @since 1.2.0
 */
public class MavLinkHeartbeat {
    ...
    /**
     * Sends the heartbeat to the {@link org.droidplanner.core.drone.Drone} object.
