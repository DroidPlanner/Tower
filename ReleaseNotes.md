...
## Droidplanner v2.7.9 RC1
* On the DroneSetup pane removed the Tuning and Calibration Fragments
* Removed unfinished/untested missionItems (Only Waypoint, Takeoff, ROI, RTL, Circle and Land are allowed)
* Removed distance/time view at the editor screen
* Removed un-finished buttons on the Circle mode fragment

## Droidplanner v2.7.8 RC1
* On the DroneSetup pane removed the Tuning and Calibration Fragments
* Removed unfinished/untested missionItems (Only Waypoint, Takeoff, ROI, RTL, Circle and Land are allowed)
* Removed distance/time view at the editor screen
* Removed un-finished buttons on the Circle mode fragment

## Droidplanner v2.7.7 RC2
* On the DroneSetup pane removed the Tuning and Calibration Fragments
* Removed unfinished/untested missionItems (Only Waypoint, Takeoff, ROI, RTL, Circle and Land are allowed)
* Removed distance/time view at the editor screen
* Removed un-finished buttons on the Circle mode fragment
* Fixed issue #1052, which was being caused by the beta branch

## Droidplanner v2.7.7 RC1
* On the DroneSetup pane removed the Tuning and Calibration Fragments
* Removed unfinished/untested missionItems (Only Waypoint, Takeoff, ROI, RTL, Circle and Land are allowed)
* Removed distance/time view at the editor screen
* Removed un-finished buttons on the Circle mode fragment

## Droidplanner v2.7.6 RC2
* On the DroneSetup pane removed the Tuning and Calibration Fragments
* Removed unfinished/untested missionItems (Only Waypoint, Takeoff, ROI, RTL, Circle and Land are allowed)
* Removed distance/time view at the editor screen
* Removed un-finished buttons on the Circle mode fragment
* Adding #1067 on the v2.7.6 release

## Droidplanner v2.7.6 RC1
* On the DroneSetup pane removed the Tuning and Calibration Fragments
* Removed unfinished/untested missionItems (Only Waypoint, Takeoff, ROI, RTL, Circle and Land are allowed)
* Removed distance/time view at the editor screen
* Removed un-finished buttons on the Circle mode fragment

## Droidplanner v2.7.5 RC1
* On the DroneSetup pane removed the Tuning and Calibration Fragments
* Removed unfinished/untested missionItems (Only Waypoint, Takeoff, ROI, RTL, Circle and Land are allowed)
* Removed distance/time view at the editor screen
* Removed un-finished buttons on the Circle mode fragment
* Removed spline waypoints

## Droidplanner v2.7.4 RC1
* On the DroneSetup pane removed the Tuning and Calibration Fragments
* Removed unfinished/untested missionItems (Only Waypoint, Takeoff, ROI, RTL, Circle and Land are allowed)
* Removed distance/time view at the editor screen
* Removed un-finished buttons on the Circle mode fragment

## Droidplanner v2.7.3 RC1
* On the DroneSetup pane removed the Tuning and Calibration Fragments
* Removed unfinished/untested missionItems (Only Waypoint, Takeoff, ROI, RTL, Circle and Land are allowed)
* Removed distance/time view at the editor screen
* Removed un-finished buttons on the Circle mode fragment

## Droidplanner v2.7.2 RC1
* On the DroneSetup pane removed the Tuning and Calibration Fragments
* Removed unfinished/untested missionItems (Only Waypoint, Takeoff, ROI, RTL, Circle and Land are allowed)
* Removed distance/time view at the editor screen
* Removed un-finished buttons on the Circle mode fragment

## Droidplanner v2.7.1 RC1
* On the DroneSetup pane removed the Tuning and Calibration Fragments
* Removed unfinished/untested missionItems (Only Waypoint, Takeoff, ROI, RTL, Circle and Land are allowed)
* Removed distance/time view at the editor screen
* Removed un-finished buttons on the Circle mode fragment

## Droidplanner v2.6.2 RC1
* On the DroneSetup pane removed the Tuning and Calibration Fragments
* Removed unfinished/untested missionItems (Only Waypoint, Takeoff, ROI, RTL, Circle and Land are allowed)
* Removed distance/time view at the editor screen
* Removed un-finished buttons on the Circle mode fragment
...
## Droidplanner v2.5.1 RC2
* Added two new follow-modes just for this release
